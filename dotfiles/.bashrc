...
function proml {
  ...
  export PS1="\[\e[0;33m\]\u\[\e[0m\]@\[\e[0;32m\]\h\[\e[0m\]:\[\e[0;34m\]\w\[\e[0m\]$LIGHT_RED\$(parse_git_branch)$YELLOW\$(evil_git_dirty)$DEFAULT\$ "
}
...
alias gd='git d --word-diff --ignore-space-at-eol -b -w $@'
